...
class OpenAIEmbeddings(BaseModel, Embeddings):
    ...
    Setup:
        Install ``tradingagents.models.langchain_doubao`` and set environment variable ``ARK_API_KEY``.

        .. code-block:: bash

            pip install -U tradingagents.models.langchain_doubao
    ...
    Instantiate:
        .. code-block:: python
            ...
            from tradingagents.models.langchain_doubao import OpenAIEmbeddings
