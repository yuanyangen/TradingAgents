...
ChatDouBao v0.3 stores reasoning and tool outputs in AIMessage.additional_kwargs:
...
reasoning items), ChatDouBao now stores these items in the content sequence:
...
old and new formats. The functions are used internally by ChatDouBao.
...
def _convert_from_v03_ai_message(message: AIMessage) -> AIMessage:
    ...
    # Only update ChatDouBao v0.3 AIMessages
